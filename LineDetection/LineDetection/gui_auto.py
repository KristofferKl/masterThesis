...
def find_nearest_white(img, target):
    ...
    coordinate = nonzero[nearest_index]        # sign = list(map(lambda x: np.sign(x), axis))
        # print(sign)
        # print(f"{angle_deg = }")
...
def main():
    ...
    df= pd.read_csv('pointcloud_dataframe.csv', sep = ',', header= None) #change this name based on the name of the file you want to read
...
#these are only used for checking coordinates by hand
